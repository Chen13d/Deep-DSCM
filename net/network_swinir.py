...
if __name__ == '__main__':
    ...
    # height = (496 // upscale // window_size + 1) * window_size
    # width = (496 // upscale // window_size + 1) * window_size

    model = SwinIR(upscale=2, in_chans=1, img_size=256,
